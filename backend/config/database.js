import {Sequalize} from 'sequelize' // importando sequelize que serve para trabalhar com banco de dados 

// aqui estamos criando uma variavel sequalize que vai receber um novo objeto sequalize
const sequelize = new Sequalize('analiseDeProjetos', 'postgres', '@Tais84671514', {
